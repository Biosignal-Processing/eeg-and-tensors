function [flt, flt_cs, y_dc, y_pca] = pre_processing(x,fs,varargin)
...
%         figure;
    ...
    % Filtering each 'ii' channel 
    for ii=1:n
        flt_cs(:,ii) = filtfilt(d,y_pca(:,ii));
    end

end

%% Clean useless variables
clearvars -except flt flt_cs y_dc y_pca
end
